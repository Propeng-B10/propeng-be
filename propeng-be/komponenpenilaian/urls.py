...
urlpatterns = [
    ...
    path('by-matpel/', get_komponen_penilaian_of_mata_pelajaran, name='get_komponen_penilaian_of_mata_pelajaran'),
    path('by-id/', get_komponen_penilaian_by_id, name='get_komponen_penilaian_by_id'),
